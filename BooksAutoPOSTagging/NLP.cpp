...
string* _NLP::getPrepositionalPhrase(string* words)
{
    ...
    {
        if (completed[x][1] == "prep." && (completed[x + 1][1] == "n." || completed[x + 1][1] == "pron."))
        {
            ...
            // Search for cluases
            if (getRelativeClause(words_temp))
            {
                prepositional_phrase[0] = completed[x][0];
                prepositional_phrase[1] = completed[x + 1][0];

                string* clause_temp = getRelativeClause(words_temp);
            ...
            if (getNounClause(words_temp))
            {
                prepositional_phrase[0] = completed[x][0];
                prepositional_phrase[1] = completed[x + 1][0];

                string* clause_temp = getNounClause(words_temp);
            ...
            if (getAdverbialClause(words_temp))
            {
                prepositional_phrase[0] = completed[x][0];
                prepositional_phrase[1] = completed[x + 1][0];

                string* clause_temp = getAdverbialClause(words_temp);
